...
// Removido Send e useState, pois o formulário de contato será removido.
// Removido toast, pois não será mais usado para o formulário.
...
export default function Contato() {
  ...
  // Removido a função handleSubmit, pois o formulário de contato será removido.
  ...
  return (
    <section id="contato" className="py-20 bg-gradient-to-b from-black to-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-1 gap-12 justify-center"> {/* Ajustado para 1 coluna */}
