...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans relative">
      ...
      {/* Header */}
      <header className="fixed top-0 w-full bg-black/90 backdrop-blur-lg border-b border-purple-500/20 z-50">
            ...
            <div className="relative">
              ...
              {isAvatarMenuOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-gray-800 border border-gray-700 rounded-lg shadow-lg py-1 z-10">
                  <button onClick={() => { setActiveTab('settings'); setIsAvatarMenuOpen(false); }} className="block px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 w-full text-left">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-12">
        ...
        {!hasActivePlan && (
          <div className="bg-gradient-to-r from-red-900/30 to-orange-900/30 backdrop-blur-sm border border-red-500/20 rounded-2xl p-6 text-center mb-10 animate-pulse">
        ...
        <div className="space-y-8">
          ...
          {activeTab === 'status' && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 shadow-xl">
                ...
                {hasActivePlan ? (
                  <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 backdrop-blur-sm border border-blue-500/20 rounded-xl p-4 text-center">
                  ...
                  <div className="bg-gradient-to-r from-red-900/30 to-orange-900/30 backdrop-blur-sm border border-red-500/20 rounded-xl p-4 text-center">
                ...
                {currentSubscription ? (
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className={`font-semibold ${currentSubscription.status === 'active' ? 'text-green-400' : 'text-red-400'}`}>
                  ...
                  {timelineSteps.map((step, index) => {
                    ...
                    return (
                      <li key={step.id} className="mb-10 ml-6">
                        <span className={`absolute flex items-center justify-center w-8 h-8 rounded-full -left-4 ring-4 ring-gray-900 ${isActive ? 'bg-gradient-to-r from-blue-500 to-purple-600 text-white' : 'bg-gray-700 text-gray-400'}`}>
                          {step.icon}
                        </span>
          ...
          {activeTab === 'updates-support' && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              {/* Quick Support Card */}
              <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 shadow-xl text-center">
            ...
            <div className="bg-gradient-to-br from-gray-800/40 to-gray-900/40 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 shadow-xl">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <button onClick={() => toast.info('Funcionalidade em breve!')} className="mt-3 text-blue-400 hover:text-blue-300 text-sm">Editar Perfil</button>
                </div>
                <div>
                  ...
                  <button onClick={() => toast.info('Funcionalidade em breve!')} className="mt-3 text-blue-400 hover:text-blue-300 text-sm">Gerenciar Notificações</button>
                </div>
                <div>
                  ...
                  <button onClick={() => toast.info('Funcionalidade em breve!')} className="mt-3 text-blue-400 hover:text-blue-300 text-sm">Personalizar Tema</button>
                </div>
              </div>
            </div>
          )}
      ...
      {showCancelConfirmation && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-900 p-8 rounded-xl shadow-2xl border border-gray-700 max-w-md w-full text-center">
